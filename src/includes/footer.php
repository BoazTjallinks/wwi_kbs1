<section id="footer" class="wwi_margin_top_normal">
    ...
    <footer class="page-footer sticky-bottom font-small wwi_mainbgcolor wwi_mainbgcolordarker">
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-center py-3 text-light">Wideworldimporters © 2020
            powered by <a href="https://windesheim.nl" class="text-secondary">Windesheim</a>
        </div>
        <!-- Copyright -->
