...
elseif (isset($_POST['asfhhfaojaobgobnpg']) && isset($_POST['email']) && isset($_POST['password1']) && isset($_POST['password2']) && isset($_POST['iughafvgohwbwh']) && isset($_POST['asfjhgwfhkkw']) && isset($_POST['wqpbuhwrgwgui'])) {
    ...
    if ($sessionid === session_id()) {
        // session_regenerate_id();
        $auth = new auth();
        echo $auth->register($email, $password1, $password2);
    }
    else {
        echo "Something went wrong! Please try again!";
    }
        ...
        <form action="#" method="POST">
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control wwi_mat_3" id="exampleInputEmail1" placeholder="Enter email" />
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Password</label>
                    <input type="password" class="form-control wwi_mat_3" id="exampleInputPassword1" placeholder="Password" />
                </div>
    ...
    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
        <form action="#" method="POST">
            <div class="form-group">
                ...
                <input type="email" class="form-control wwi_mat_3" id="inputEmail4" placeholder="Email">
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputPassword4">Password</label>
                    <input type="password" class="form-control wwi_mat_3" id="inputPassword4" placeholder="Password">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputPassword4">Repeat</label>
                    <input type="password" class="form-control wwi_mat_3" id="inputPassword4"
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control wwi_mat_3" id="inputZip">
                </div>
