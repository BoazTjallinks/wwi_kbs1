        ...
        <div class="container d-none d-lg-block">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <?php
                    if(!$soldOut){
                        print("<div class=\"col\"><input type=\"hidden\" name=\"stockItemID\" value=\"".$id."\"><button class=\"btn btn-primary\" id=\"add-button-desktop\" type=\"submit\">Add to shopping cart</button></div>");
                    }else{
